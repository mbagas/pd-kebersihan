...
Route::prefix('admin')->middleware(['auth', 'verified', 'role:admin'])->group(function () {
    ...
    // Master Data
    Route::resource('master/mitra', MitraController::class)->names('admin.mitra');
    Route::resource('master/armada', ArmadaController::class)->names('admin.armada');
    Route::resource('master/tarif', TarifController::class)->names('admin.tarif');
