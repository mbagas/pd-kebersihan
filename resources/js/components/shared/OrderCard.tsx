    ...
    return (
        ...
        >
            <CardHeader className="pb-2">
                <div className="flex items-start justify-between gap-2">
                    <div className="space-y-1">
                        ...
                        <h3 className="font-semibold leading-tight">{order.customer_name}</h3>
                    </div>
                    <CustomerTypeBadge type={order.customer_type} showIcon={false} />
                </div>
            </CardHeader>
            <CardContent className="space-y-2 pb-2">
                ...
                {order.partner_type && <PartnerLabel type={order.partner_type} name={order.partner_name} />}
            </CardContent>
