        ...
        <PublicLayout>
            ...
            <section className="bg-gradient-to-b from-primary/10 to-background py-20">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="mb-4 text-4xl font-bold tracking-tight md:text-5xl">
                        Layanan Sedot Tinja
                        <span className="block text-primary">Terpercaya & Profesional</span>
                    </h1>
                    <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
                        PD. Kebersihan Tapis Berseri melayani kebutuhan pengelolaan air limbah domestik untuk rumah tangga dan
            ...
            <section className="py-16">
                <div className="container mx-auto px-4">
                    <h2 className="mb-8 text-center text-2xl font-bold">Mengapa Memilih Kami?</h2>
